        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    PreferredCurrencyId = table.Column<Guid>(type: "uuid", nullable: true),
                    PreferredLanguageId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clients_Currencies_PreferredCurrencyId",
                        column: x => x.PreferredCurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Clients_Languages_PreferredLanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartTypeId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    DefaultMarkupPercentage = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCompatibleModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductCompatibleModels_DeviceModels_ModelId",
                        column: x => x.ModelId,
                        principalTable: "DeviceModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCompatibleModels_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlacedByUserId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "SerializedInventoryUnits",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ShopId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    UnitBarcode = table.Column<string>(type: "text", nullable: false),
                    SerialNumber = table.Column<string>(type: "text", nullable: true),
                    Imei1 = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SerializedInventoryUnits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SerializedInventoryUnits_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SerializedInventoryUnits_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SourceShopId = table.Column<Guid>(type: "uuid", nullable: false),
                    DestinationShopId = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Notes = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTransfers_Shops_DestinationShopId",
                        column: x => x.DestinationShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransfers_Shops_SourceShopId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    SerializedInventoryUnitId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockMovements_SerializedInventoryUnits_SerializedInventory~",
                        column: x => x.SerializedInventoryUnitId,
                        principalTable: "SerializedInventoryUnits",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_PreferredCurrencyId",
                table: "Clients",
                column: "PreferredCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Clients_PreferredLanguageId",
                table: "Clients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCompatibleModels_ModelId",
                table: "ProductCompatibleModels",
                column: "ModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCompatibleModels_ProductId",
                table: "ProductCompatibleModels",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SerializedInventoryUnits_ProductId",
                table: "SerializedInventoryUnits",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SerializedInventoryUnits_ShopId",
                table: "SerializedInventoryUnits",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_SerializedInventoryUnits_TenantId_UnitBarcode",
                table: "SerializedInventoryUnits",
                columns: new[] { "TenantId", "UnitBarcode" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopInventories_ShopId",
                table: "ShopInventories",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopInventories_TenantId_ShopId_ProductId",
                table: "ShopInventories",
                columns: new[] { "TenantId", "ShopId", "ProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_SerializedInventoryUnitId",
                table: "StockMovements",
                column: "SerializedInventoryUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransfers_DestinationShopId",
                table: "StockTransfers",
                column: "DestinationShopId");

            migrationBuilder.CreateIndex(
                name: "IX_StockTransfers_SourceShopId",
                table: "StockTransfers",
                column: "SourceShopId");
